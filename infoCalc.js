...
const currentPrice = 0.06570; // стартовая стоимость монеты в у.е.(например: 0.54, 2.34)
const percentDecr = [1, 2, 4, 5, 6]; //процент снижения цены (например: 2%, 1.5% (знак процента не пишем))
const totalSum = 134 * 10; // общая сумма (всего денег) (она будет делиться 50/50 и на кол-во стеков)
